<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy2\WWW\myblog\public/../application/admin\view\admin\index.html";i:1486812789;s:39:"../application/common/layout/index.html";i:1486784064;s:38:"../application/common/view/header.html";i:1486778746;s:38:"../application/common/view/footer.html";i:1486476083;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
						...
						<tr>
							...
							<td>
								<?php if(!(empty($admin['avatar']) || (($admin['avatar'] instanceof \think\Collection || $admin['avatar'] instanceof \think\Paginator ) && $admin['avatar']->isEmpty()))): ?>
									<img src="<?php echo UPLOAD_URL; ?>avatar/<?php echo $admin['avatar']; ?>" alt="头像" style="max-width:30px;max-height:30px;">
								<?php else: ?>
									无
								<?php endif; ?>
							</td>
							<td><?php echo $admin['register_time']; ?></td>
